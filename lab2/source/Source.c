...
int main(void)
{
	...
	fopen_s(&pRead,"D://課程//程式語言//class//ch7//lab2//lab2//credit.txt", "r");
	if (NULL == pRead)
	{
		return 0;
	}
	fopen_s(&pWrite,"D://課程//程式語言//class//ch7//lab2//lab2//credit_bin.txt", "wb+");
	if (NULL == pWrite)
	{
		fclose(pRead);
		return 0;
	...
	system("pause");
	printf("\n讀取二進位資料檔案，並格式化輸出如下 : \n");
	fopen_s(&cfPtr, "D://課程//程式語言//class//ch7//lab2//lab2//credit_bin.txt", "rb");
	if (cfPtr == NULL)
	{
